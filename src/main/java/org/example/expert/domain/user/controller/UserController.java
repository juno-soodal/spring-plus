...
import org.example.expert.domain.user.dto.UserChangeProfileImageRequest;
...
public class UserController {
    ...
    @GetMapping("/users")
    public ResponseEntity<Page<UserResponse>> getUsers(@RequestParam String nickname, @PageableDefault() Pageable pageable) {
